...
const Blog = () => {
    const blogs = [
        { id: 1, title: "Lorem ipsum dolor sit amet consectetur adipisicing", image: Blog1 },
        { id: 2, title: "Lorem ipsum dolor sit amet consectetur adipisicing", image: Blog2 },
        { id: 3, title: "Lorem ipsum dolor sit amet consectetur adipisicing", image: Blog3 },
    ]
    return (
                    ...
                    blogs.map(blog => <div key={blog.id} className='mx-auto relative mb-12 cursor-pointer'>
                        ...
                        <div className='text-center px-4 py-8 bg-white shadow-lg rounded-md md:w-3/4 mx-auto absolute left-0 right-0 -bottom-12'>
                            ...
                            <div className='flex items-center justify-center gab-8'>
                                <a href="/" className='font-bold text-brandPrimary hover:text-neutral-700'>Lorem pirem neque 
                                    <svg className='inline-block ml-2' width="17" height="11" viewBox="0 0 17 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="Right">
